...
const blogPosts = [
  { id: 1, title: "Basketball", description: "Master the art of dribbling, shooting, and team play with our expert basketball training programs.", image: "/basketball.jpg", category: "Team Sport" },
  { id: 2, title: "Cricket", description: "From batting techniques to bowling strategies, become a cricket pro with professional coaching.", image: "/cricket.jpg", category: "Team Sport" },
  { id: 3, title: "Gym Swimming", description: "Combine strength training with aquatic workouts for full-body fitness and endurance.", image: "/gym.jpeg", category: "Fitness" },
  { id: 4, title: "Football", description: "Develop your footwork, tactical awareness, and teamwork skills on the pitch.", image: "/football.jpeg", category: "Team Sport" },
  { id: 5, title: "Yoga", description: "Let you relax all you muscles and mind with the Yoga sessions ", image: "/yoga.jpeg", category: "Exercise" },
  { id: 6, title: "Badminton Agility", description: "Improve your agility, reflexes, and smashing power on the badminton court.", image: "/badminton.avif", category: "Racket Sport" },
];
    ...
    >
      ...
      <div className="relative h-56 overflow-hidden">
        ...
        <div className="absolute top-4 left-4">
          <span className="bg-[#6BA358] text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider shadow-lg">
            {post.category}
          </span>
        </div>
      </div>
      ...
      <div className="p-6 flex flex-col flex-grow">
        <h3 className="text-2xl font-bold text-[#2D4A22] mb-3 group-hover:text-[#6BA358] transition-colors leading-tight">
          {post.title}
        </h3>
        ...
        <div className="mt-auto flex justify-end items-center pt-4 border-t border-gray-50">
          <motion.button
            ...
            className="bg-[#6BA358] hover:bg-[#D4AF37] text-white px-5 py-2 rounded-lg text-xs font-bold uppercase tracking-widest flex items-center gap-2 transition-colors duration-300 shadow-sm"
          >
            Read More
...
const Blog = () => {
  ...
  const handleCardClick = (post) => {
    // Navigates to the details page and passes the post data via state
    navigate(`/blog/${post.id}`, { state: { post } });
    
    // Ensures the user starts at the top of the detail page
    ...
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16 border-l-4 border-[#6BA358] pl-6">
          <h1 className="text-5xl font-black text-[#2D4A22] mb-2 tracking-tight">Our Blog</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <aside className="lg:col-span-1 space-y-12">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center relative overflow-hidden">
                ...
                <h2 className="text-2xl font-bold text-[#2D4A22] mb-2">Hello, I'm Steven</h2>
            ...
            {/* Popular Posts */}
            <div>
              <h4 className="font-black uppercase tracking-[0.2em] text-[#2D4A22] text-xs mb-8 flex items-center gap-4">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-center gap-4 group cursor-pointer">
                    ...
                    <div>
                      <h5 className="font-bold text-sm text-[#2D4A22] leading-snug group-hover:text-[#6BA358] transition-colors mb-1">{item.title}</h5>
